...
class GoogleSheetsHelper:
    ...
    Paste_Orientation = namedtuple("_Paste_Orientation", ("normal", "transpose"))(
        "NORMAL", "TRANSPOSE"
    )

    Merge_Type = namedtuple(
        "_Merge_Type", ("merge_all", "merge_columns", "merge_rows")
    ...
    Value_Input_Option = namedtuple("_Value_Input_Option", ("raw", "user_entered"))(
        "RAW", "USER_ENTERED"
    )

    Value_Render_Option = namedtuple(
        "_Value_Render_Option", ["formatted", "unformatted", "formula"]
